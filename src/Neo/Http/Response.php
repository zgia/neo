...
class Response extends SymfonyResponse
{
     ...
     * @param null|array $allowMethods An array or null, cannot be '*'
     * @param null|array $allowHeaders An array or null, cannot be '*'
     */
    public function sendAccessControlHeaders(int $maxage = 86400, bool $credentials = false, string $origin = '*', array $allowMethods = null, array $allowHeaders = null)
    {
        if (is_null($origin) || $origin == 'null') {
