...
<div class="container">
  <div class="row margin-top-20">
    <div class="col-md-12">
      <div
          class="panel panel-<?php echo $extension['isError'] ? 'danger' : ($extension['isError'] === 0 ? 'success' : 'default'); ?>">
          ...
          <p class="lead"><?php echo $message; ?></p>
			...
			<?php if ($extension['more'] && is_array($extension['more'])) { ?>
              ...
              <dl class="dl-horizontal">
                ...
                <dt><?php echo $k; ?></dt>
                <dd<?php echo $k == 'Error' ? ' class="text-danger"' : ''; ?>><?php echo $v; ?></dd>
				<?php } ?>
              </dl><?php } ?>
    ...
    echo "<span id=\"redirectTime\">{$extension['redirectTime']}</span>";
    _f(
        'Seconds after the auto-jump, does not support frames, please <a href="%s">click here</a> to jump manually or click <a href="javascript:history.back(1)">Back</a> to retry.',
        $extension['url']
    );
